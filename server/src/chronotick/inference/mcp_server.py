...
async def main():
    ...
    if args.debug_trace:
        ...
        debug_modules = [
            "chronotick.inference.mcp_server.debug",
            "chronotick.inference.real_data_pipeline.debug",
            "chronotick.inference.daemon.debug",
            "chronotick.inference.ntp_client.debug",
            "chronotick.inference.predictive_scheduler.debug",
            "chronotick.inference.engine.debug"
        ]
